...
public class SQLiteFuncTest {
    ...
    @Test
    public void testStringFunc() throws Exception {
    ...
    @Test
    public void testLongFunc() throws Exception {
    ...
    @Test
    public void testDoubleFunc() throws Exception {
    ...
    @Test
    public void testBlobFunc() throws Exception {
